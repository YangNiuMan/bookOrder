	...
	<div class="wrapper">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						...
						<div class="table-box">
							...
							<form action="${pageContext.request.contextPath}/role/search" method="post">
									...
									<c:forEach items="${pageInfo.list}" var="role">
										<tr>
											...
											<td class="text-center">
												...
												<a href="javascript:deleteUser(${role.id})" class="btn bg-olive btn-xs">删除权限</a>
												<a href="${pageContext.request.contextPath}/role/findByRoleId.do?id=${role.id}" class="btn bg-olive btn-xs">编辑角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
		...
		<script>
            ...
            function deleteUser(id) {
                ...
                if(confirm("确认删除")){
                    //访问路径
                    location.href="${pageContext.request.contextPath}/role/delete.do?id="+id;
                }
            };
