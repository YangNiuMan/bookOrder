...
<div class="center_content">
	...
	<div class="left_content">
		...
		<div class="title"><span class="title_icon"><img src="../img/bullet1.gif"/></span>最新出版</div>
     
     	<c:forEach items="${pageInfo.list}" var="ne1">
	     
			<div class="feat_prod_box">
				<div class="prod_img">
					<a href="${pageContext.request.contextPath}/userBook/findById?id=${ne1.id}">
						<img src="..${ne1.cover}" class="thumb_big" border="0"/>
					</a>
				</div>
				<div class="prod_det_box"><span class="new_icon"><img src="../img/new_icon.gif"/></span>
					<div class="box_top"></div>
					<div class="box_center">
						<div class="prod_title"><a href="${pageContext.request.contextPath}/userBook/findById?id=${ne1.id}">${ne1.name}</a></div>
						<c:if test="${ne1.id%3==1}">
							<div><p class="details" id="piot">${ne1.intro}</p></div>
						</c:if>
						<c:if test="${ne1.id%3==2}">
							<div><p class="details" id="piot1">${ne1.intro}</p></div>
						</c:if>
						<c:if test="${ne1.id%3==0}">
							<div><p class="details" id="piot2">${ne1.intro}</p></div>
						</c:if>
						<a href="${pageContext.request.contextPath}/userBook/findById?id=${ne1.id}" class="more">- 图书详情 -</a>
						<div class="clear"></div>
					</div>
