...
<div class="center_content">
	...
	<div class="left_content">
		...
		<div class="title"><span class="title_icon"><img src="../img/bullet1.gif"/></span>优惠促销</div>
     
     	<c:forEach items="${pageInfo.list} var=sa">
     
			<div class="feat_prod_box">
				<div class="prod_img">
					<a href="${pageContext.request.contextPath}/userBook/findById?id=${sa.id}">
						<img src="..${sa.cover}" class="thumb_big" border="0"/>
					</a>
				</div>
				<div class="prod_det_box"><span class="special_icon"><img src="../img/promo_icon.gif"/></span>
					<div class="box_top"></div>
					<div class="box_center">
						<div class="prod_title"><a href="${pageContext.request.contextPath}/userBook/findById?id=${sa.id}">${sa.name}</a></div>
						...
						<a href="${pageContext.request.contextPath}/userBook/findById?id=${sa.id}" class="more">- 图书详情 -</a>
						<div class="clear"></div>
					</div>
