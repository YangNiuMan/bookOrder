	...
	<div class="wrapper">
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" title="刷新" onclick="location.href='${pageContext.request.contextPath}/permission/findAll.do'">
											<i class="fa fa-refresh"></i> 刷新
										</button>
									</div>
								</div>
							</div>
							<form action="${pageContext.request.contextPath}/permission/search" method="post">
								<div class="box-tools pull-right">
									<div class="form-group">
										<input type="text" class="form-control" name="sous" placeholder="请输入角色名称">
									</div>
								</div>
								<div class="box-tools pull-right">
									<div class="form-group form-inline">
									...
									<c:forEach items="${pageInfo.list}" var="p">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/permission/findDetail.do?id=${p.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/permission/findByPeId.do?id=${p.id}" class="btn bg-olive btn-xs">编辑权限</a>
												<a href="javascript:deleteUser(${p.id})" class="btn bg-olive btn-xs">删除权限</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
		...
		<script>
            ...
            function deleteUser(id) {
                ...
                if(confirm("确认删除")){
                    //访问路径
                    location.href="${pageContext.request.contextPath}/permission/deletePermission.do?id="+id;
                }
            }
