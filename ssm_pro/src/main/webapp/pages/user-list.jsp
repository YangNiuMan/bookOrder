									...
									<c:forEach items="${pageInfo.list}" var="user">
										<tr>
											...
											<td class="text-center">
												...
												<%--<a href="${pageContext.request.contextPath}/user/delSelected?id=${user.id}" class="btn bg-olive btn-xs">删除用户</a>
--%>
												<a href="javascript:deleteUser(${user.id})" class="btn bg-olive btn-xs">删除用户</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
